...
class ProductTemplate(models.Model):
    ...
    clave_prod_catalogo_sat_id = fields.Many2one('cfdi.clave_prod_serv',string='Productos y Servicios', help='Clave Producto y Servicios segun el catalogo del sat')
    clave_unidad_clave_catalogo_sat_id = fields.Many2one('cfdi.clave_unidad',string='Clave Unidad', help='Unidad de medida utilizada segun el catalogo del sat')
